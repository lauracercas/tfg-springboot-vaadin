...
@Route(value = "productos/merchan", layout = MainView.class)
@PageTitle("Merchandising")
public class MerchanListView extends VerticalLayout{
	...
	@Autowired
	public MerchanListView(UsuarioService usuarioService, ProductoService productoService,
		...
		add(new H2("Merchandising en Venta"),productos);
